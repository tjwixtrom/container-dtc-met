...
docker run -it --rm \
 -v ${MET_TUTORIAL_DIR}/MET_Tutorial:/met/met-8.1.1/MET_Tutorial \
 --name met-8.1.1-tutorial met-8.1.1 /bin/bash
cd /met/met-8.1.1
...
#   - All tutorial commands should be run from the /met/met-8.1.1 directory.
